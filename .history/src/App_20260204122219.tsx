    ...
    <div className="min-h-screen bg-background">
      <main className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col px-6 pb-16 pt-28">
        {!voiceMode && (
          <>
            <Button
              className="fixed left-1/2 top-5 z-20 -translate-x-1/2 rounded-full bg-white text-sm text-foreground shadow-lg ring-1 ring-black/5 hover:bg-muted"
              variant="outline"
            ...
            <div className="fixed right-6 top-5 z-20 flex items-center gap-3 rounded-full border bg-white px-4 py-2 shadow-lg ring-1 ring-black/5">
              ...
              <Button className="h-9 rounded-full px-4 text-xs" variant="secondary">
                Comprar
              </Button>
            </div>
          </>
          ...
          <section className="flex flex-col gap-10">
            <header className="space-y-2 text-center">
              ...
              <h1 className="text-3xl font-semibold md:text-4xl">
                Colección minimalista de rutas y escapadas
              </h1>
            </header>
