...
function createChatWidget() {
    if (!document.getElementById('chat-widget-styles')) {
        ...
        styleEl.textContent = `
            ...
            .flag-br {
                ...
                background-image:
                    radial-gradient(circle at center, #002776 0 26%, transparent 27%),
    ...
    header.innerHTML = `
        <div class="lang-picker">
            ...
            <div id="lang-menu" class="flag-menu" role="menu" aria-hidden="true">
                <button class="flag-option flag-us" type="button" data-lang="ENG" aria-label="English"></button>
                <button class="flag-option flag-br" type="button" data-lang="POR" aria-label="Português"></button>
            </div>
        </div>
        <span class="icon-slot" aria-hidden="true">
    ...
    function applyLanguage(lang) {
        ...
        if (lang === 'ESP') {
            langCurrent.classList.add('flag-es');
            langCurrent.setAttribute('aria-label', 'Idioma: Español');
        } else if (lang === 'ENG') {
            langCurrent.classList.add('flag-us');
            langCurrent.setAttribute('aria-label', 'Language: English');
        } else {
            langCurrent.classList.add('flag-br');
            langCurrent.setAttribute('aria-label', 'Idioma: Português');
        }
    }
